<<<<<<< HEAD
# Substitui o README.md pelo conteúdo final (mesmo que haja conflito)
cat > README.md << 'EOF'
=======
<<<<<<< HEAD
>>>>>>> e23858a (Resolve conflito no README.md)
...
- <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" alt="CSS3" width="20"/> **CSS3** – Estilização moderna e responsiva  
...
git commit -m "Resolve conflito do README.md"

# Push da branch
git push origin SP02--Projetos
=======
O front-end agora utiliza Vite e está localizado em `src/front`. O back-end está em `src/back`.
=======
